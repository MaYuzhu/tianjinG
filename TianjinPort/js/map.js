...
var url1 = 'https://geohey.com/s/mapviz/5910e38eb3ba4defb85be957874ab016/' +
    '/mapserver/{z}/{x}/{y}.png?ak=OGJkMGQwNTVlNzYzNDA0NmIwNDYxZDY4YjQwYmJlYzc';
var url2 = 'https://geohey.com/s/mapviz/6e6c3164c2ad44409d80116a39840a86/' +
    '/mapserver/{z}/{x}/{y}.png?ak=OGJkMGQwNTVlNzYzNDA0NmIwNDYxZDY4YjQwYmJlYzc';
var url3 = 'https://geohey.com/s/mapviz/f6bd3ee41217430ba4d8dadf553227ed/' +
    '/mapserver/{z}/{x}/{y}.png?ak=OGJkMGQwNTVlNzYzNDA0NmIwNDYxZDY4YjQwYmJlYzc';
var url4 = 'https://geohey.com/s/mapviz/1fa12ba5a3744ffb8de38c7f0c0abef7/' +
    '/mapserver/{z}/{x}/{y}.png?ak=OGJkMGQwNTVlNzYzNDA0NmIwNDYxZDY4YjQwYmJlYzc';
var url5 = 'https://geohey.com/s/mapviz/bd14a16acdd940358a0ca3f91c5a2ca7/' +
    '/mapserver/{z}/{x}/{y}.png?ak=OGJkMGQwNTVlNzYzNDA0NmIwNDYxZDY4YjQwYmJlYzc';
var url6 = 'https://geohey.com/s/mapviz/5a680c07978c4d37893ad35f95018bbe/' +
    '/mapserver/{z}/{x}/{y}.png?ak=OGJkMGQwNTVlNzYzNDA0NmIwNDYxZDY4YjQwYmJlYzc';
//var pos = [13110795.607205058,4719031.500290665];
var pos = ol.proj.transform([117.78688073,38.98251417], 'EPSG:4326', 'EPSG:3857');

ajax_geo_map('https://geohey.com/s/mapviz/5910e38eb3ba4defb85be957874ab016/mapserver/config?ak=OGJkMGQwNTVlNzYzNDA0NmIwNDYxZDY4YjQwYmJlYzc','5910e38eb3ba4defb85be957874ab016')
ajax_geo_map('https://geohey.com/s/mapviz/6e6c3164c2ad44409d80116a39840a86/mapserver/config?ak=OGJkMGQwNTVlNzYzNDA0NmIwNDYxZDY4YjQwYmJlYzc','6e6c3164c2ad44409d80116a39840a86')
ajax_geo_map('https://geohey.com/s/mapviz/f6bd3ee41217430ba4d8dadf553227ed/mapserver/config?ak=OGJkMGQwNTVlNzYzNDA0NmIwNDYxZDY4YjQwYmJlYzc','f6bd3ee41217430ba4d8dadf553227ed')
ajax_geo_map('https://geohey.com/s/mapviz/1fa12ba5a3744ffb8de38c7f0c0abef7/mapserver/config?ak=OGJkMGQwNTVlNzYzNDA0NmIwNDYxZDY4YjQwYmJlYzc','1fa12ba5a3744ffb8de38c7f0c0abef7')
ajax_geo_map('https://geohey.com/s/mapviz/bd14a16acdd940358a0ca3f91c5a2ca7/mapserver/config?ak=OGJkMGQwNTVlNzYzNDA0NmIwNDYxZDY4YjQwYmJlYzc','bd14a16acdd940358a0ca3f91c5a2ca7')
ajax_geo_map('https://geohey.com/s/mapviz/5a680c07978c4d37893ad35f95018bbe/mapserver/config?ak=OGJkMGQwNTVlNzYzNDA0NmIwNDYxZDY4YjQwYmJlYzc','5a680c07978c4d37893ad35f95018bbe')
...
/*$.ajax({
    type:"POST",
    url:'https://geohey.com/s/mapviz/5910e38eb3ba4defb85be957874ab016/mapserver/' +
    'config?ak=OGJkMGQwNTVlNzYzNDA0NmIwNDYxZDY4YjQwYmJlYzc',
    async: false,
    cache: true,
    dataType: 'json',
    data:{uid:'5910e38eb3ba4defb85be957874ab016'},
    success: function (json) {
        console.log(json)
    },
})*/
